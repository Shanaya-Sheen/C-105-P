...
classifier= ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/SVPX3Y65M/model.json" , modelLoaded);
...
function gotResult(results , error){
    if(error){
        ...
        console.log(name);
        document.getElementById("result-object-name").innerHTML = name;
